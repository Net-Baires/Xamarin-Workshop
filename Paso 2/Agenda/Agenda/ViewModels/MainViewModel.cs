...
namespace Agenda.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        public MainViewModel()
        {
            ...
            Contacts.Add(new ContactViewModel() { Initial = "E", Name = "Esteban", LastName = "Yañez", Mail = "eyanez.89@gmail.com" });
            Contacts.Add(new ContactViewModel() { Initial = "G", Name = "Germán", LastName = "Küber", Mail = "german.kuber@outlook.com" });
        }
